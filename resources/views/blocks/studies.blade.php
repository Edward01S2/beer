<div id="jobs" class="{{ $block->classes }} border-t border-dashed border-c-blue-100">
  ...
  <div>
    <div class="py-12 lg:flex lg:py-0">
      <div class="container mx-auto beer-width">
        <div class="lg:py-12 xl:pr-12">
          <div class="px-6 lg:px-0 lg:pr-8">
            ...
            <div class="swiper-wrapper">
              @foreach($items as $item)
                <div class="swiper-slide job-{!! $loop->index !!} overflow-hidden">
                  <div class="">
                    <div class="p-6 pb-12 overflow-hidden lg:p-8 lg:pb-10 lg:pl-0 lg:pt-4">
                      <img class="border-[10px] border-white shadow h-56 w-full object-cover object-center sm:h-96 job-img lg:h-80 xl:h-[22rem]" src="{!! $item['image']['url'] !!}" alt="">
                    </div>
                    <div class="p-6 pt-0 prose-sm lg:p-8 lg:pt-0 lg:pl-0 max-w-none">
                      {!! $item['content'] !!}
                    </div>
                  </div>
                </div>
      ...
      <div class="hidden lg:block lg:w-1/3 lg:flex-grow">
          ...
          @foreach($items as $item)
            <button class="border-b border-dashed border-c-blue-100 text-c-blue-100 study-btn focus:outline-none @if($loop->first){{ 'active' }}@endif" data-index="{!! $loop->index !!}">
              <div class="flex items-center px-10">
                <img class="object-cover object-center w-20 h-20 mr-4 border-2 rounded-full border-c-blue-100 xl:mr-8" src="{!! $item['image']['url'] !!}" alt="">
                <div class="text-left font-rec lg:text-xl xl:text-2xl">{!! $item['title'] !!}</div>
              </div>
            </button>
          @endforeach
        </div>
